...
const ObraCardAlcances = memo(function ObraCardAlcances({ obra, onAbrirAlcances, direccionVisible }) {
  ...
  return (
    <div
      ...
      style={{
        background: ALCANCES_THEME.cardBg,
        border: ALCANCES_THEME.cardBorder,
        boxShadow: ALCANCES_THEME.cardShadow,
      }}
    >
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 flex-1">
            ...
            {obra.clave_unica && (
              <span
                ...
                style={{
                  ...
                  color: "#21543a",
                  border: "1px solid rgba(33,84,58,0.24)",
                }}
              >
                {obra.clave_unica}
              </span>
          ...
          {referencia && (
            <p className="mt-0.5 text-xs" style={{ color: ALCANCES_THEME.subtitle }}>
              {referencia}
            </p>
          )}
          ...
          <div className="mt-2 flex items-center gap-2">
            <div
              ...
              style={{ height: "6px", backgroundColor: "#dcebe2" }}
            >
              <div
            ...
            <span className="text-xs font-bold shrink-0" style={{ color: ALCANCES_THEME.accentStrong }}>
              {avance}%
            </span>
          </div>
        </div>
        ...
        <button
          ...
          style={{
            backgroundColor: hovered ? "#0c472c" : "#166534",
            color: "#fff",
            border: "1px solid rgba(18,74,48,0.18)",
            cursor: "pointer",
            whiteSpace: "nowrap",
            boxShadow: hovered ? "0 10px 18px rgba(15,81,50,0.18)" : "0 6px 14px rgba(15,81,50,0.12)",
          }}
        >
          📋 Alcances
        </button>
    ...
    <div className="rounded-xl overflow-hidden" style={{ border: `1px solid ${config.border}` }}>
      ...
      >
        <div className="overflow-hidden">
          <div
            className="space-y-1.5 p-2 transition-opacity duration-200"
      ...
      >
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: ALCANCES_THEME.accent }}>
              Programa
            </p>
            <h3 className="mt-0.5 text-sm font-bold truncate" style={{ color: ALCANCES_THEME.title }}>
              {prog.programa}
            </h3>
          </div>
...
export default function AgregarAlcances() {
  ...
  const groupedData = useMemo(() => {
    ...
    return base.reduce((acc, obra) => {
      const direccion = obra.direccion_general || "SIN DIRECCION";
      const programa = obra.programa || "SIN PROGRAMA";
      if (!acc[direccion]) acc[direccion] = {};
      if (!acc[direccion][programa]) acc[direccion][programa] = [];
      acc[direccion][programa].push(obra);
      return acc;
    }, {});
  }, [base, searchMode]);
    ...
    return Object.entries(groupedData)
      .map(([direccion, programasMap]) => {
        ...
        return {
          direccion,
          programas,
          totalObras: programas.reduce((acc, programa) => acc + programa.obras.length, 0),
  ...
  const togglePrograma = useCallback((key) => {
    setProgramaAbierto((prev) => (prev === key ? null : key));
  }, []);
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-5 max-w-7xl mx-auto w-full">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  ...
                  <h1 className="mt-1 text-2xl lg:text-3xl font-bold" style={{ color: "#ffffff" }}>📌 Agregar Alcances</h1>
                ...
                <div className="flex gap-2">
                  <div className="rounded-xl px-3 py-2" style={{ backgroundColor: ALCANCES_THEME.statBg, border: ALCANCES_THEME.statBorder, backdropFilter: "blur(6px)" }}>
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-10 py-2.5 text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-[#166534]"
              ...
              {busqueda && (
                <button
                  ...
                  style={{ color: "#6f8a79", background: "none", border: "none", cursor: "pointer" }}
          ...
          {loading ? (
            ...
            resultadosBusqueda.length === 0 ? (
              <div
                className="text-center py-14 rounded-3xl shadow-md"
            ...
            <div
              className="text-center py-14 text-sm rounded-3xl shadow-md"
              style={{ color: ALCANCES_THEME.subtitle, border: ALCANCES_THEME.panelBorder, backgroundColor: "#fbfefc", boxShadow: ALCANCES_THEME.panelShadow }}
            >
            ...
            <div className="space-y-3">
              {vistaPorDG && direcciones.map((dir) => (
                ...
                >
                  <button
                    type="button"
                    onClick={() => toggleDg(dir.direccion)}
                    className="w-full text-left px-4 py-3"
