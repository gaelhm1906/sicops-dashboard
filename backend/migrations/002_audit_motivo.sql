-- ============================================================
-- MIGRACIÓN 002 — Auditoría con motivo del cambio
-- Actualiza fn_audit_obras() para capturar application.motivo
-- desde SICOPS al hacer modificaciones de atributos.
-- ============================================================
...
BEGIN
    ...
    v_usuario := COALESCE(current_setting('application.user',   true), current_user);
    v_motivo  := current_setting('application.motivo', true);  -- captura motivo desde SICOPS
...
DO $$ BEGIN
  RAISE NOTICE '✓ fn_audit_obras actualizada — captura application.motivo';
END; $$;
